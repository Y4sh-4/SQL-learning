...
COPY company_dim
FROM 'C:\SQL learning\VS SQL\csv\company_dim.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

COPY skills_dim
FROM 'C:\SQL learning\VS SQL\csv\skills_dim.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

COPY job_postings_fact
FROM 'C:\SQL learning\VS SQL\csv\job_postings_fact.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

COPY skills_job_dim
FROM 'C:\SQL learning\VS SQL\csv\skills_job_dim.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');
...
SELECT 
     COUNT(job_id) AS  Data_Analyst_job,
     CASE 
